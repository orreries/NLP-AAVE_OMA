...
I started by gathering my two main corpora: ~300 comedy screenplays (IMSDB) and a JSON collection of tweets grouped by hashtag/topic. For tweets, I loaded each JSON file into pandas, converted it to a clean DataFrame, checked .head(), and exported each to CSV for later use.
